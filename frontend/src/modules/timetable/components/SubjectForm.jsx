...
export default function SubjectForm() {
  ...
  const filteredSubjects = subjectsList.filter((s) => {
    ...
    const sectionMatch =
      !filterSection || subjectSectionId === String(filterSection);
    const semesterMatch =
      !filterSemester || subjectSemester === String(filterSemester);
    ...
    <div className="content-narrow stack">
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="muted">
            Choose a semester and section before entering subject details.
          </p>
        </div>
          ...
          <div className={`form-grid ${disabled ? "disabled-fields" : ""}`}>
            ...
            <label className="form-field">
              ...
              <input
                ...
                type="number"
                min="1"
                placeholder="Enter weekly slots"
                value={weeklySlots}
                ...
                <tr>
                  <td colSpan="6">
                    <div className="empty-state">
                      No subjects to show for the selected filter.
                    </div>
                  </td>
                </tr>
              ) : (
